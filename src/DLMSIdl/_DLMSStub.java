...
/**
* DLMSIdl/_DLMSStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from DLMS.idl
* Thursday, 7 March, 2019 1:21:05 AM IST
*/

public class _DLMSStub extends org.omg.CORBA.portable.ObjectImpl implements DLMSIdl.DLMS
{
  ...
  public String addToQueue (String userID, String itemID)
  {
            ...
            try {
                ...
                return addToQueue (userID, itemID        );
            } finally {
                _releaseReply ($in);
            }
  } // addToQueue
  ...
  public String printLibrary (String managerID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("printLibrary", true);
                $out.write_string (managerID);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
  ...
  public void startServer ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("startServer", true);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public String checkBorrowList (String userID, String itemID)
  {
            ...
            try {
                ...
                return checkBorrowList (userID, itemID        );
            } finally {
                _releaseReply ($in);
            }
  } // checkBorrowList
  ...
  public String checkBookAvailability (String itemID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("checkBookAvailability", true);
                $out.write_string (itemID);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
                ...
                return checkBookAvailability (itemID        );
            } finally {
                _releaseReply ($in);
            }
